                    ...
                    <div class='accordion' id='accordionExample'>
                        ...
                        <div class='card'>
                            ...
                            <div class='row card-header' id='headingFourteen'>
                                ...
                                {{-- FORM --}}
                                <div class='col-6 form-group box2'>
                        ...
                        <div class='card'>
                            ...
                            {{-- CARD-BODY --}}
                            <div id='collapseFifteenth' class='collapse' aria-labelledby='headingFifteenth' data-parent='#accordionExample'>
                                <div class='card-body'>
                        ...
                        <div class='card'>
                            ...
                            {{-- CARD-BODY --}}
                            <div id='collapseSixteenth' class='collapse' aria-labelledby='headingSixteenth' data-parent='#accordionExample'>
                                <div class='card-body'>
                        ...
                        <div class='card'>
                            ...
                            {{-- CARD-BODY --}}
                            <div id='collapseSeventeenth' class='collapse' aria-labelledby='headingSeventeenth' data-parent='#accordionExample'>
                                <div class='card-body'>
